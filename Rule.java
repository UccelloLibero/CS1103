...
write newContent into the current cell on th tape, and will then move
either to the left or to the right on the tape, depending on whether the
value of the moveLeft is true or false.
*/
...
public class Rule {
  ...
  // Create a rule with default value for the instance variables.
  public Rule() {}
