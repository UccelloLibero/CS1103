...
/**
A test program for the Tape class that calls most of the methods in the Tape class.
The expected output should be:
Tape Content: Hello World
...
public class TestTape {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Tape Content: " + tape.getTapeContents());
    tape.moveRight();
